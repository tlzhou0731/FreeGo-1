    ...
    <div id="scenicCarousel1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/scenic_show_1.jpg" class="d-block w-50" alt="First slide">
            </div>
            <div class="carousel-item">
                <img src="images/scenic_show_2.jpg" class="d-block w-50" alt="second slide">
            </div>
            <div class="carousel-item">
                <img src="images/scenic_show_3.jpg" class="d-block w-50" alt="third slide">
            </div>
        </div>
