...
public interface UserInfoDao {
    ...
    * @param:   [userTele, email, password]
    * @Description: 系统根据手机号userTele或邮箱email和密码password匹配用户信息表（userList），若匹配成功返回true,若匹配不成功，返回 false。
    */
    Boolean isAccountRight(String userTele, String email, String password);
